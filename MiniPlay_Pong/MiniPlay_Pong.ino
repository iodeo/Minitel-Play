...
void displayWelcome() {
  ...
  for (int i=0; i<PONG_LOGO_SIZE; i++) {
...
void displayTrophies() {
  ...
  if (trophies >= BEAT_WOOD_ROOKIE) {
    minitel.newXY(16,5); minitel.print("WOOD");
    minitel.printChar(' ');minitel.repeat(6);minitel.print("RUBBER");
  }
...
void displayRobert() {
  eraseScreen();
  for (int i=0; i<ROBERT_BODY_SIZE; i++) {
  ...
  for (int i=0; i<ROBERT_HEAD_SIZE; i++) {
